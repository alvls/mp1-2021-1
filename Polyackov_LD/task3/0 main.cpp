...
{
    setlocale(LC_ALL, "Ru");
    cout << "\n Табулятор функции!\n\n Важная информация:\n 1) При изменении функции, количества точек табулирования или\n отрезка табулирования, данные предыдущего табулирования становятся\n недоступными для вывода на экран или записи в файл!\n 2) Для вывода информации на экран или записи информации в файл\n требуется предварительно протабулировать функцию!" << endl;
    while (menu()) {}
    system("pause");
}

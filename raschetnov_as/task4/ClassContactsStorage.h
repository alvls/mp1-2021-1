...
public:
  ...
  Contact contactByFullName(string _firstName, string lastName, string patronymic, bool& indicator);
  Contact contactByPhoneNumber(string _phoneNumber, bool& indicator);
  vector <Contact> everyContactByFirstLetter(char _letter, bool& indicator);
  ...
  size_t getIndex(const Contact& object);
};
#endif